...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    <section class="section">
         ...
         <asp:UpdatePanel ID="upTablaTareas" runat="server">
            <ContentTemplate> 
                <div class="container text-center">
                    <h2><asp:Label ID="lblMisTareasActivas" runat="server" Text="Mis tareas activas"></asp:Label></h2>
                    <br />
                </div>
                    ...
                    <HeaderTemplate>
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><asp:Label ID="hdlblFinalizar" runat="server" Text="Finalizar"></asp:Label></th>
                                    <th scope="col"><asp:Label ID="hdlblInformarProblema" runat="server" Text="Informar problema"></asp:Label></th>
                                </tr>
                            </thead>
                        <tbody>
                    </HeaderTemplate>
        ...
        <asp:UpdatePanel ID="upTarea" runat="server">
            <ContentTemplate>
                <div id="divInformarProblema" runat="server" visible="false">
                    ...
                    <div id="InformacionProblema" runat="server">
                        <div class="row">
                            <div>
                                <asp:Label ID="Label3" CssClass="col-sm-4 " runat="server" Text="Describa el problema que le impide desarrollar la tarea: "></asp:Label>
